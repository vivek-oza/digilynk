      ...
      <div className="relative z-10">
          ...
          >
            ...
            >
              <motion.p
                ...
                variants={fadeInUp}
              >
                Your <span className="text-blue-500 font-medium">Vision</span>,
                Our <span className="text-green-500 font-medium">Code</span>,
              </motion.p>
              <motion.p
                className="text-base text-center md:text-start text-zinc-600 tracking-tight font-medium leading-relaxed"
                variants={fadeInUp}
        ...
        >
          ...
          <motion.div className="md:w-1/2 mb-8 md:mb-0" variants={fadeInLeft}>
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              We are dedicated to delivering creative, secure, and
              high-performance websites tailored to your business needs. Our
              team of passionate developers blends innovative web design with
              robust development practices, ensuring every project is visually
              stunning, bug-free, and optimized for growth.
            </motion.p>
            <motion.p
              className="text-base text-zinc-600 tracking-tight font-medium leading-relaxed"
              variants={fadeInUp}
            >
        ...
        >
          <motion.div className="md:w-2/3" variants={fadeInLeft}>
            <motion.h2
              className="text-3xl mb-10 text-center text-zinc-800"
              variants={fadeInUp}
            >
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              A website is essential for business growth in today's digital
              landscape. It acts as your virtual storefront, allowing customers
              to discover your products and services at any time, from anywhere.
            </motion.p>
            <motion.p
              className="text-base text-zinc-600 tracking-tight font-medium leading-relaxed mb-4"
              variants={fadeInUp}
            >
              With more than 80% of consumers researching online before making a
              purchase, having a professional website ensures you're visible
              when potential customers are searching for solutions you offer.
              This continuous online presence expands your reach, generates new
              leads, and opens up opportunities for increased sales and
              profitability.
            </motion.p>
            <motion.p
              className="text-base text-zinc-600 tracking-tight font-medium leading-relaxed mb-4"
              variants={fadeInUp}
            >
              Beyond visibility, a website builds credibility and trust with
              your audience. A well-designed, informative site signals
              professionalism and reliability, making customers more likely to
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              It also serves as a central hub for your marketing efforts,
              supporting SEO, social media campaigns, and paid advertising, all
              of which drive targeted traffic and accelerate business growth.
            </motion.p>
          </motion.div>
        </motion.section>
          ...
          <motion.div className="max-w-4xl w-full" variants={fadeInUp}>
            ...
            >
              <div className="space-y-4 flex flex-col">
                <h1 className="text-base">Website Types</h1>
              ...
              <div className="space-y-4 flex flex-col">
                <h1 className="text-base">Specialized Websites</h1>
                <div className="text-zinc-300 space-y-4">
                  <p>Hotel Websites</p>
        ...
        >
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              Web design is a critical factor in shaping your business's first
              impression. Visitors form opinions about your brand within seconds
              of landing on your site, and a visually appealing, user-friendly
              design can immediately convey trust, professionalism, and
              credibility. A modern, clean layout not only attracts attention
              but also encourages users to explore your offerings, increasing
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              Effective web design goes beyond aesthetic. It ensures intuitive
              navigation, fast loading times, and mobile responsiveness, all of
              which enhance the user experience. By investing in high-quality
              web design, your business stands out in a crowded market, leaving
              a memorable impression that builds customer confidence and
              loyalty.
            </motion.p>
          </motion.div>
        </motion.section>
        ...
        >
          <motion.div className="mb-12" variants={fadeInUp}>
            <motion.h2
              className="text-3xl font-semibold text-zinc-800 mb-4"
              variants={fadeInUp}
            >
              Our Development Approach
            </motion.h2>
            <motion.h3 className="text-3xl font-semibold" variants={fadeInUp}>
        ...
        >
          <motion.div className="w-full" variants={fadeInLeft}>
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              At Digilynk, we specialize in crafting modern, aesthetic, and
              uniquely appealing web designs that elevate your brand identity.
              Our creative team blends the latest design trends with your
              business goals, ensuring every website is visually stunning,
              clean, and easy to navigate. We prioritize minimalism and clarity,
              using whitespace, balanced color schemes, and striking visuals to
              create an engaging and memorable digital experience.
            </motion.p>
            <motion.p
              className="text-xl text-zinc-600 tracking-tight font-medium leading-relaxed mb-4 max-w-5xl mx-auto"
              variants={fadeInUp}
            >
              Every project at Digilynk is tailored to your specific needs,
              resulting in a website that is not only beautiful but also highly
              functional and responsive across all devices. Our commitment to
              originality means your site will stand out with a design that's
              truly one-of-a-kind reflecting your brand's personality and values
              while driving user engagement and conversions.
            </motion.p>
          </motion.div>
        </motion.section>
      </div>
