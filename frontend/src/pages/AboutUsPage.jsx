    ...
    return (
        <div className="relative">
            ...
            <div className="relative  z-10">
                ...
                >
                    <motion.h2
                        className="text-5xl font-semibold text-zinc-800 mb-12 text-center"
                        variants={fadeInUp}
                    >
                        Why choose us?
                    </motion.h2>
...
//                 >
//                     <motion.h2
//                         className="text-5xl font-semibold text-zinc-800 mb-6 text-center"
//                         variants={fadeInUp}
//                     >
//                         Why choose us?
//                     </motion.h2>
...
//                             >
//                                 <h2 className="text-5xl font-semibold text-zinc-800 mb-6">{card.title}</h2>
//                                 <p className="text-xl text-zinc-600 tracking-tight font-medium leading-relaxed">
//                                     {card.description}
//                                 </p>
//                             </motion.div>
