...
import { ChevronDown, Monitor, Home, Users, BookOpen } from "lucide-react";
  ...
  return (
    <motion.nav
      className={`fixed top-5 w-full max-w-[93%] mx-auto left-0 right-0 h-16 flex items-center justify-between px-6 z-50 transition-all duration-300 rounded-xl ${
        scrolled
          ? "bg-black/30 backdrop-blur-xl shadow-lg shadow-zinc-900/50 border border-white/10"
            ...
            <AnimatePresence>
              {servicesOpen && (
                <motion.ul
                  ...
                  className="absolute top-full left-0 mt-2 w-64 bg-black/30 backdrop-blur-xl shadow-xl rounded-2xl py-2 z-50 border border-white/10"
                >
                  {[
                    {
                    ...
                    <motion.li
                      ...
                      className="px-4 py-3 text-gray-300 hover:text-white cursor-pointer transition-all duration-300 mx-2 rounded-xl group"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="lg:hidden fixed top-16 right-0 w-full bg-black/30 rounded-2xl mt-2 backdrop-blur-xl border-l border-b border-white/10 shadow-2xl flex justify-start mobile-menu-container overflow-hidden"
          >
            <div className="relative w-full p-5">
              <ul className="flex flex-col gap-2 font-medium">
                ...
                >
                  <button
                    className="w-full text-left py-3 px-4 text-gray-300 hover:text-white rounded-xl transition-all duration-300 font-medium flex items-center gap-3"
                    onClick={() => handleNavigation("/")}
                  >
                    <Home size={18} />
                    HOME
                ...
                >
                  <div
                    className="flex justify-between items-center w-full py-3 px-4 text-gray-300 hover:text-white rounded-xl transition-all duration-300 cursor-pointer"
                      ...
                      >
                        {[
                          ...
                          <motion.li
                            ...
                            className="py-2 px-4 text-gray-400 hover:text-white rounded-lg cursor-pointer transition-all duration-300"
                            onClick={() => handleNavigation(service.path)}
                          >
                ...
                >
                  <button
                    className="w-full text-left py-3 px-4 text-white rounded-xl transition-all duration-300 font-medium border border-zinc-700 hover:border-zinc-500"
                    onClick={() => handleNavigation("/contact")}
                  >
                    CONTACT
                  </button>
