    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center py-6 md:py-16 bg-white gap-16">
        <motion.div className="md:w-2/3" initial="hidden" whileInView="visible" variants={fadeInLeft}>
          <h2 className="text-5xl mb-10 font-semibold text-center text-zinc-800">Why Website is important?</h2>
          <motion.p className="text-xl text-zinc-600 tracking-tight font-medium leading-relaxed" initial="hidden" whileInView="visible" variants={fadeInUp}>
      ...
      <div className="w-full bg-white py-16 px-4 md:px-16">
        <div className="flex flex-col items-center justify-center text-start">
          <motion.div className="w-full" initial="hidden" whileInView="visible" variants={fadeInLeft}>
            ...
            <h4 className="text-2xl font-semibold text-zinc-500 mb-6">Creative Web Design Excellence</h4>
            <motion.p
        ...
        <div className="flex flex-col items-center justify-center text-start">
          <motion.div className="w-full" initial="hidden" whileInView="visible" variants={fadeInLeft}>
            <h4 className="text-2xl font-semibold text-zinc-500 mb-6">Bug-Free, Smooth, and Secure Websites</h4>
            <motion.p
              className="text-xl text-zinc-600 tracking-tight font-medium leading-relaxed mb-4 max-w-5xl mx-auto"
              initial="hidden"
              whileInView="visible"
        ...
        <div className="flex flex-col items-center justify-center text-start">
          <motion.div className="w-full" initial="hidden" whileInView="visible" variants={fadeInLeft}>
            <h4 className="text-2xl font-semibold text-zinc-500 mb-6">Accelerate Your Business Growth</h4>
            <motion.p
              className="text-xl text-zinc-600 tracking-tight font-medium leading-relaxed mb-4 max-w-5xl mx-auto"
              initial="hidden"
              whileInView="visible"
        ...
        <div className="flex flex-col items-center justify-center text-start">
          <motion.div className="w-full" initial="hidden" whileInView="visible" variants={fadeInLeft}>
            <h4 className="text-2xl font-semibold text-zinc-500 mb-6">First Impressions That Build Trust</h4>
            <motion.p
              className="text-xl text-zinc-600 tracking-tight font-medium leading-relaxed mb-4 max-w-5xl mx-auto"
              initial="hidden"
              whileInView="visible"
        ...
        <div className="flex flex-col items-center justify-center text-start">
          <motion.div className="w-full" initial="hidden" whileInView="visible" variants={fadeInLeft}>
            <h4 className="text-2xl font-semibold text-zinc-500 mb-6">Efficient, Research-Driven Processes</h4>
            <motion.p
              className="text-xl text-zinc-600 tracking-tight font-medium leading-relaxed mb-4 max-w-5xl mx-auto"
              initial="hidden"
              whileInView="visible"
        ...
        <div className="flex flex-col items-center justify-center text-start">
          <motion.div className="w-full" initial="hidden" whileInView="visible" variants={fadeInLeft}>
            <h4 className="text-2xl font-semibold text-zinc-500 mb-6">On-Time Delivery</h4>
            <motion.p
              className="text-xl text-zinc-600 tracking-tight font-medium leading-relaxed mb-4 max-w-5xl mx-auto"
              initial="hidden"
              whileInView="visible"
      ...
      <div className="flex flex-col md:flex-row items-center justify-between p-6 md:p-16 bg-white gap-16">
        <motion.div className="mb-8 flex flex-col md:mb-0" initial="hidden" whileInView="visible" variants={fadeInLeft}>
          <h2 className="text-5xl font-semibold text-center text-zinc-800 mb-12">We believe in Design</h2>
          <motion.p className="text-xl text-zinc-600 tracking-tight font-medium leading-relaxed" initial="hidden" whileInView="visible" variants={fadeInUp}>
      ...
      <div className="flex flex-col items-center justify-center">
        <motion.div className="w-full" initial="hidden" whileInView="visible" variants={fadeInLeft}>
          <h4 className="text-3xl font-semibold text-zinc-900 mb-6">Modern, Aesthetic, Clean, and Appealing Unique Designs</h4>
          <motion.p
            className="text-xl ms-4 flex flex-col space-y-2 text-zinc-600 tracking-tight font-medium leading-relaxed mb-4 max-w-5xl mx-auto"
            initial="hidden"
            whileInView="visible"
            variants={fadeInUp}
          >
