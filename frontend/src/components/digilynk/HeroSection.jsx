    ...
    return (
        <>
            ...
            <section className='flex flex-col space-y-10 my-60'>
                ...
                <div className='flex items-center justify-center text-center text-2xl px-20 text-zinc-600 tracking-tight font-medium leading-relaxed'>We design and develop websites, apps and digital experiences that help our clients grow, innovate, and transform. We listen, learn and understand before we build. We identify your goals together, then use our expertise to find that sweet spot of realistic and impactful.</div>
            </section>
        </>
    )
}
