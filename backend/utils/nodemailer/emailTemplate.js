/**
 * Responsive Minimal Sleek Bento UI Email Template for Nodemailer
 *
...
const bgColors = {
  main: "#F1F5F9",
  card: "#FFFFFF",
  logoBg: "#F3F4F6", // Lighter background for logo (zinc-100 equivalent)
};
...
<body style="font-family: 'Hanken Grotesk', Arial, sans-serif; background-color: ${
    bgColors.main
  }; color: #18181B; padding: 16px; line-height: 1.6; margin: 0;">
  <div style="max-width: 800px; margin: 0 auto;">
    <!-- Important notice bar -->
    <div style="background-color: ${
      accentColors.blue
    }; color: white; text-align: center; padding: 12px; border-radius: 12px; margin-bottom: 24px; font-weight: 500;">
      Please respond to the client within 24 hours
    </div>
    
    <!-- Header -->
    <div style="display: flex; flex-direction: column; align-items: center; text-align: center; gap: 16px; margin-bottom: 24px; padding: 20px; border-radius: 12px; background-color: white; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.06);">
      <div style="background-color:rgba(0, 0, 0, 0); padding: 12px; border-radius: 999px;">
        <img src="${
          data.logoURL ||
          "https://ik.imagekit.io/digilynk/digilynk_logo_dark.png"
        }" alt="Company Logo" style="width: 60px; height: 60px; object-fit: contain;">
      </div>
      <div>
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 24px;">
      <tr>
        <td valign="top" width="100%" style="display: block; padding-bottom: 24px;">
    ...
    <div style="background: ${
      bgColors.card
    }; border-radius: 12px; padding: 24px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.06); position: relative; overflow: hidden; margin-bottom: 24px;">
      <div style="display: flex; align-items: center; margin-bottom: 20px;">
        <div style="width: 8px; height: 8px; border-radius: 50%; background-color: ${
          accentColors.blue
        }; margin-right: 10px;"></div>
    ...
    <div style="text-align: center; font-size: 14px; color: #64748B; padding: 10px;">
      <p style="margin: 0;">© ${new Date().getFullYear()} Digilynk. All rights reserved.</p>
    </div>
  </div>
</body>
</html>`;
